# Relatório — sempaginacao

**Arquivo CSV:** `/Users/lambda/Tutoriais/blog-post/backend/MetricsResults/sempaginacao.csv`
**Imagem gerada:** `/Users/lambda/Tutoriais/blog-post/backend/MetricsResults/sempaginacao_plot.png`
...
- Energia total estimada: **143.770420 J**
- Potência média (Energia/ΔT): **1.797355 W**

## Intervalo HTTP (marcado em vermelho no gráfico)
- HTTP_START (ms): `1501`
- HTTP_END (ms): `8376`
- Duração HTTP: **6.875000 s**
