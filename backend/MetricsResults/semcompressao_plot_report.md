# Relatório — semcompressao

**Arquivo CSV:** `/Users/lambda/Tutoriais/blog-post/backend/MetricsResults/semcompressao.csv`
**Imagem gerada:** `/Users/lambda/Tutoriais/blog-post/backend/MetricsResults/semcompressao_plot.png`
...
- Energia total estimada: **130.939540 J**
- Potência média (Energia/ΔT): **1.636949 W**

## Intervalo HTTP (marcado em vermelho no gráfico)
- HTTP_START (ms): `1501`
- HTTP_END (ms): `8039`
- Duração HTTP: **6.538000 s**
